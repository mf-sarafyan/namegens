...
Includes a more torchified code with a way larger model, more data, and some generation. Also includes some debugging of the activations and gradients to ensure the model is training correctly.
